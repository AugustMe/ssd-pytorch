...
os.environ["CUDA_VISIBLE_DEVICES"] = "0" # 多卡训练出错，还未解决
...
class SSD(object):
    _defaults = {
        "model_path"    : 'logs/Epoch100-Total_Loss0.7790-Val_Loss0.9596.pth',
    ...
    def generate(self):
        ...
        if self.cuda:
            ...
            # self.net = torch.nn.DataParallel(self.net,device_ids=[0]) # 多卡训练出错，还未解决
